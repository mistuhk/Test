import { React, AllWidgetProps, appActions } from 'jimu-core'
import { JimuMapViewComponent, JimuMapView } from 'jimu-arcgis'
import { DataSourceComponent, FeatureLayerDataSource, DataSourceManager } from 'jimu-core'
import { Pagination } from 'jimu-ui'
import Graphic from 'esri/Graphic'
import { IMConfig } from '../config'
import { fetchData, callRowAction, callGlobalAction } from '../shared/services/gridApiService'
import { getAllUrlParams } from '../shared/services/urlParamService'
...
const Widget = (props: AllWidgetProps<IMConfig>) => {
  ...
  const columns = getColumns()
  const showButtons = props.config.showButtons || false
          ...
          <tbody>
            ...
            {currentItems.map((item, rowIndex) => {
              ...
              return (
                ...
                >
                  {/* Checkbox — only when showButtons and more than 1 row total */}
                  {showButtons && originalData.length > 1 && (
                  ...
                  {showButtons && (
                    <td style={{ ...tdStyle(isSelected, isEven), textAlign: 'center' }}>
                      <button
