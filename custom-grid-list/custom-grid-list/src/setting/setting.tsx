          ...
          <SettingSection title={fmt('sectionPerRow', defaultI18nMessages.sectionPerRow)}>
            ...
            <SettingRow>
              ...
              <textarea
                ...
                onChange={e => this.props.onSettingChange({
                  id: this.props.id,
                  config: this.props.config.set('rowActionFields', e.target.value)
                })}
              />
            </SettingRow>
            ...
            <SettingSection title={fmt('sectionGlobalPayload', defaultI18nMessages.sectionGlobalPayload)}>
                ...
                <>
                  ...
                  <SettingRow>
                    ...
                    <textarea
                      ...
                      onChange={e => this.props.onSettingChange({
                        id: this.props.id,
                        config: this.props.config.set('globalActionFields', e.target.value)
                      })}
                    />
                  </SettingRow>
                </>
              ...
              <SettingRow>
                ...
                <textarea
                  ...
                  onChange={e => this.props.onSettingChange({
                    id: this.props.id,
                    config: this.props.config.set('globalButtonDefaultValues', e.target.value)
                  })}
                />
              </SettingRow>
