...
const Widget = (props: AllWidgetProps<IMConfig>) => {
  ...
  return (
    <div style={containerStyle}>
      ...
      {/* Title bar — shown or hidden based on the showTitle setting.
          Text falls back to the default translation if titleText is not configured. */}
      {props.config.showTitle !== false && (
        <h6 style={headerStyle}>
          {props.config.titleText || defaultMessages.formTitle}
        </h6>
      )}
