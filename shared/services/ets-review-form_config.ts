...
export interface Config {
  ...
  // When true, the blue title bar is rendered at the top of the widget.
  // When false, the title bar is hidden entirely.
  showTitle: boolean

  // The text displayed in the title bar when showTitle is true.
  // Falls back to the default 'ETS Review Form' translation if empty.
  titleText: string
}
